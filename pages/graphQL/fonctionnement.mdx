...
GraphQL repose sur une approche déclarative qui permet aux clients de demander précisément les données dont ils ont besoin, tout en laissant au serveur le soin de les fournir selon les spécifications définies dans un schéma.  
