...
- **Couches (layers)** :
  ...
  Une image Docker 📦 est constituée de couches successives. Chaque instruction dans un **<Term word="Dockerfile">Dockerfile</Term>** (le script de création de l'image) génère une nouvelle couche, empilée sur la précédente pour former l'image finale.
...
- **Création de conteneurs** :
  ...
  Lorsque vous lancez une image 📦, Docker 🐳 crée un <Term word="conteneur">conteneur</Term> 🚚 (instance isolée) qui exécute l’application de façon autonome, quel que soit l’hôte.
