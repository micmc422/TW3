...
Voici une sélection des commandes <Term word="Docker">Docker</Term> les plus courantes, classées par catégories pour une utilisation efficace au quotidien.
...
- **`docker run [OPTIONS] IMAGE [COMMAND] [ARG...]`**  
  Lance un nouveau <Term word="conteneur">conteneur</Term> à partir d'une <Term word="image">image</Term>.  
...
- **`docker build -t TAG PATH`**  
  Crée une nouvelle image à partir d'un <Term word="Dockerfile">Dockerfile</Term> situé dans le répertoire spécifié.
- **`docker images`**  
...
- **`docker volume create VOLUME`**  
  Crée un <Term word="volume">volume</Term> Docker pour le stockage de données persistantes.
- **`docker volume ls`**  
...
- **`docker-compose down`**  
  Arrête et supprime les conteneurs et réseaux créés par <Term word="Docker Compose">Docker Compose</Term>.
- **`docker-compose ps`**  
