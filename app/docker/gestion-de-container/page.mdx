...
<Term word="Docker">Docker</Term> 🐳 permet d’exécuter des applications dans des environnements isolés appelés **conteneurs** 🚚. La commande `docker run` est essentielle pour lancer un <Term word="conteneur">conteneur</Term> 🚚 à partir d’une <Term word="image">image</Term> 📦, en permettant de configurer divers paramètres comme le réseau, les volumes 💾 et les ports.
...
Pour accéder à votre application dans un conteneur 🚚, ouvrez un navigateur et entrez l’<Term word="URL">URL</Term> suivante :
