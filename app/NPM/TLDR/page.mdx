...
<Term word="Git">Git</Term> est un système de gestion de versions décentralisé permettant de suivre les modifications apportées à des fichiers et de collaborer efficacement sur des projets.
...
Les branches permettent de travailler sur des fonctionnalités distinctes sans affecter la <Term word="branche">branche</Term> principale. `git branch` et `git checkout` permettent de créer et de passer entre les branches, tandis que `git merge` fusionne les branches.
