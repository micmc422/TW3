...
Apprendre aux étudiants de licence informatique (3ème année) à utiliser <Term word="Git">Git</Term>, un système de gestion de version décentralisé. La formation couvrira les concepts clés, les commandes essentielles et inclura des exercices pratiques pour manipuler un dépôt Git. Un test final permettra de valider les acquis.
...
- **3.3 Effectuer un <Term word="commit">commit</Term>**
...
- **4.1 Qu'est-ce qu'une <Term word="branche">branche</Term> ?**
...
- **7.2 Pull requests et Merge requests**
  - Explication du processus de <Term word="pull request">pull request</Term> et de review de code sur GitHub/GitLab
