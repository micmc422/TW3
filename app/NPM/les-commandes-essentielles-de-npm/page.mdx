...
## 🚀 Initialisation d’un projet
 - **`npm init`** 🏗️ : Cette commande initialise un nouveau projet Node.js et crée un fichier `package.json`, qui contient les informations sur le projet et ses dépendances.
  ```bash copy
  npm init
  ```
