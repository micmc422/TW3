...
<Term word="ESLint">ESLint</Term> est un outil d'analyse statique de code JavaScript qui permet d'identifier et de corriger les erreurs de programmation, les anti-patterns et les problèmes de style de code.
...
3. 🎨 Combinez avec <Term word="Prettier">Prettier</Term> pour une meilleure gestion du formatage
