...
Le client <Term word="REST">REST</Term> est un outil qui permet d'effectuer des requêtes <Term word="HTTP">HTTP</Term> vers des <Term word="API">API</Term> REST. Il est disponible dans de nombreux environnements de développement et peut être utilisé pour tester et déboguer des API.

## 🛠️ Installation

Pour installer le client REST, vous pouvez utiliser <Term word="npm">npm</Term> :
