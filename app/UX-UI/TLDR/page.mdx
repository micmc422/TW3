...
- **Design System** : un ensemble de composants, règles et standards réutilisables pour assurer la cohérence d'un produit (ex. Material Design, <Term word="Tailwind">Tailwind</Term> UI, Ant Design).
