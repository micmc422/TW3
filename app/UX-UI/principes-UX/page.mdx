...
| **Pertinente** | Effort utile qui aide à apprendre | Un tutoriel interactif qui guide pas à pas |

✅ **L’objectif en UX** : réduire la charge **extrinsèque** (parasites) et maximiser la charge **pertinente** (apprentissage utile).
