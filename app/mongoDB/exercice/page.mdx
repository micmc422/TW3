...
- L'<Term word="image">image</Term> <Term word="Docker">Docker</Term> officielle de <Term word="MongoDB">MongoDB</Term> peut être trouvée sur le [Hub Docker - MongoDB](https://hub.docker.com/_/mongo), offrant une solution prête à l'emploi pour le déploiement de bases de données MongoDB dans des conteneurs Docker.

- [<Term word="Express">Express</Term>](https://www.npmjs.com/package/express/) est un framework web minimaliste et flexible pour <Term word="Node.js">Node.js</Term>, permettant de créer des applications web robustes et évolutives.

- [MongoDB](https://www.npmjs.com/package/mongodb/) est un système de gestion de base de données <Term word="NoSQL">NoSQL</Term> orienté <Term word="document">document</Term>.

- [Body-Parser](https://www.npmjs.com/package/body-parser) est un <Term word="middleware">middleware</Term> Node.js facilitant le traitement des données du corps des requêtes <Term word="HTTP">HTTP</Term> dans une application Express.
