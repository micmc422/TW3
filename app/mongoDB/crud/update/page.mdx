...
3. **`replaceOne()` :** Cette méthode remplace entièrement un <Term word="document">document</Term> qui correspond à un critère donné. Elle est utile lorsque vous souhaitez remplacer un document existant par un nouveau.
