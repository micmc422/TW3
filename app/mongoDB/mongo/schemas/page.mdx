...
Considérons un blog dans lequel les utilisateurs peuvent ajouter des articles avec des champs dynamiques. Un utilisateur peut ajouter des informations supplémentaires à chaque article sans définir de <Term word="schéma">schéma</Term> fixe à l'avance.
...
Dans cet exemple, le <Term word="document">document</Term> peut évoluer au fil du temps en fonction des besoins des utilisateurs. Certains articles peuvent avoir des champs supplémentaires, tandis que d'autres peuvent en avoir moins, offrant ainsi une grande flexibilité.
