...
Une fois Node.js et npm installés, créez un projet React "pur" avec Create React App. Cette méthode est simple, pédagogique et fournit une configuration prête à l'emploi (Babel, Webpack, JSX transform).
...
3. (Optionnel) Pour démarrer avec TypeScript :
