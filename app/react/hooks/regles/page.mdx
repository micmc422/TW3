...
## ⚛️ 1. Ne pas appeler les Hooks à l'intérieur des boucles, des conditions ou des fonctions imbriquées
...
## ⚛️ 2. Appeler les Hooks uniquement à partir de fonctions de composant ou de fonctions personnalisées
...
## ⚛️ 3. Utiliser les Hooks uniquement à partir de packages React
