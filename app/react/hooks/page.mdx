...
- [`useState`](/react/hooks/natif#%EF%B8%8F-usestate) : Permet d'ajouter un état local à un composant fonctionnel.
...
- [`useRef`](/react/hooks/natif#%EF%B8%8F-useref) : Permet d'accéder à des éléments du DOM et de garder des références mutables.
