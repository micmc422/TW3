...
<Term word="Next.js">Next.js</Term> 13+ simplifie l’intégration des polices grâce à `next/font`. Cette <Term word="API">API</Term> optimise les polices pour de meilleures performances :  

✅ Chargement optimisé des polices (<Term word="lazy loading">lazy loading</Term>, sous-ensembles automatiques).  
...
Si vous utilisez <Term word="Tailwind">Tailwind</Term>, ajoutez la police dans `tailwind.config.js` :  
...
🛠 **Utilisation dans un <Term word="composant">composant</Term>**  
