...
<Term word="Next.js">Next.js</Term> 13+ introduit des fonctionnalités avancées pour optimiser les performances de votre application :  
...
Grâce au **<Term word="streaming">streaming</Term>**, on peut afficher **progressivement** les parties d’une page au fur et à mesure du chargement.  
...
✅ **Explication** :  
- Chaque <Term word="composant">composant</Term> **se charge indépendamment**.  
