...
<Term word="Next.js">Next.js</Term> propose un <Term word="composant">composant</Term> **optimisé** pour l’affichage des images : [`next/image`](https://nextjs.org/docs/pages/api-reference/components/image). Il améliore les performances en :  
...
🛠 **Utilisation d’une <Term word="image">image</Term> distante**  
```tsx copy
<Image 
...
Next.js permet d’adapter automatiquement les images à la taille du <Term word="conteneur">conteneur</Term>.  
...
- `object-cover` (avec <Term word="Tailwind">Tailwind</Term>) : Garde le ratio de l’image sans déformation.  
...
Pour des cas spécifiques (<Term word="CDN">CDN</Term> externe, transformations d’image...), on peut utiliser un **loader personnalisé**.  
...
✅ Un **<Term word="lazy loading">lazy loading</Term>** natif pour de meilleures performances.  
