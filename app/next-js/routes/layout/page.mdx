...
L’un des grands avantages du **<Term word="App Router">App Router</Term> (`app/`)** est la gestion des **layouts imbriqués** grâce aux fichiers `layout.tsx`. Cela permet de structurer l’interface sans recharger les éléments communs (ex: navigation, footer).  
