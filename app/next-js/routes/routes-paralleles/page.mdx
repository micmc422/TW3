...
Les **Routes Parallèles** (Parallel Routes) sont une fonctionnalité puissante de <Term word="Next.js">Next.js</Term> 13+ qui permet de **rendre plusieurs pages simultanément** dans une même mise en page. Cela permet de créer des interfaces complexes comme des **dashboards**, des **modales**, ou des **vues côte à côte**.  
...
│   ├── page.tsx      → Contenu du slot sidebar
```
...
📍 **Le layout reçoit les slots comme <Term word="props">props</Term> enfants**  
...
├── @sidebar/
│   ├── page.tsx
│   ├── loading.tsx   → Loader spécifique à la sidebar
```
...
✔ **Modales natives** → Ouvrez des modales via l'<Term word="URL">URL</Term> sans perdre le contexte.  
