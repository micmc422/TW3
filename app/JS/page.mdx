...
Un objet en JavaScript est une <Term word="collection">collection</Term> de **paires clé-valeur**. Voici quelques manières de créer un objet :  
...
L’objet `document` représente la **structure HTML** de la page. Il permet de manipuler le <Term word="DOM">DOM</Term>.
