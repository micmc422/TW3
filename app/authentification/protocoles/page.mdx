...
**<Term word="HTTP">HTTP</Term> basic auth :**  
- **Fonctionnement :**  
...
- **Inconvénients :**  
  - **Pas sécurisé** sans <Term word="HTTPS">HTTPS</Term> (les identifiants peuvent être interceptés).  
...
**<Term word="OAuth">OAuth</Term> 2.0 :**  
- **Fonctionnement :**  
...
- **Inconvénients :**  
  ...
  - Moins flexible que OAuth ou OpenID Connect pour les <Term word="API">API</Term> modernes.
