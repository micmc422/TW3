...
**Code <Term word="Node.js">Node.js</Term> de départ :**
```javascript copy
...
**Ajout d’une CSP dans les headers <Term word="HTTP">HTTP</Term> :**
```javascript copy
...
**Solution :**  
- Ajouter les options `HttpOnly`, `Secure`, et `SameSite` aux cookies de <Term word="session">session</Term>.
