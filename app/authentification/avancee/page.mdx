...
**WebAuthn (Web Authentication <Term word="API">API</Term>)** est une norme introduite par le W3C et soutenue par la FIDO Alliance. Elle permet une authentification forte sans mot de passe, utilisant des dispositifs matériels ou biométriques.
...
1. **OTP (One-Time Password) :**  
   ...
   **Exemple d’intégration avec Google Authenticator (<Term word="Node.js">Node.js</Term>):**
   ```bash copy
   ```
