...
### ⚙️ Utiliser le module `http` pour créer un serveur
...
<Steps>
### 🗺️ Implémenter une gestion de routes basique avec Node.js
...
- La route `/about` ℹ️ doit afficher une page "À propos".
