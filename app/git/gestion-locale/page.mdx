...
Dans cette section, nous allons explorer les concepts et commandes de base pour gérer un dépôt <Term word="Git">Git</Term> local.
...
Une fois les fichiers ajoutés, vous pouvez effectuer un <Term word="commit">commit</Term> pour enregistrer définitivement les changements :
