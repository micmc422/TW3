...
Le travail collaboratif est l'un des aspects les plus puissants de <Term word="Git">Git</Term>. Dans cette section, nous allons explorer comment travailler efficacement avec d'autres développeurs sur un même projet.
...
Assurez-vous d'être sur la <Term word="branche">branche</Term> correcte avant de pousser.
...
- Écrivez des messages de <Term word="commit">commit</Term> clairs et détaillés
