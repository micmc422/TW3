...
Les branches sont l'un des éléments les plus puissants de <Term word="Git">Git</Term>. Elles permettent de travailler simultanément sur différentes versions d'un projet tout en conservant une seule ligne de développement principale.

## ❓ Qu'est-ce qu'une branche ?

Une <Term word="branche">branche</Term> est une ligne temporaire de développement. Elle permet de tester des idées sans affecter directement la branche principale du projet.
...
3. Faites un <Term word="commit">commit</Term> sur la branche `feature` :
   ```bash copy
   git add .
